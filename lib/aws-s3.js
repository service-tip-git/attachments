...
module.exports = class AWSAttachmentsService extends require("./basic") {
  ...
  async put(attachments, data, isDraftEnabled, _content, req) {
    console.log("[DEBUG LORA] - AWSAttachmentsService put method called", data);
    console.log("[DEBUG LORA] - attachments", attachments);
    console.log("[DEBUG LORA] - isDraftEnabled", isDraftEnabled);
    console.log("[DEBUG LORA] - _content", _content);
    ...
    console.log("[DEBUG LORA] - AWSAttachmentsService put method - input", input);
    try {
      ...
      console.log("[DEBUG LORA] - AWSAttachmentsService put method - stored and uploaded", stored);
